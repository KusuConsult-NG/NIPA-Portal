        ...
        <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            >
                {LEADERS.map((leader, i) => (
                    <div
                        key={i}
                        className="min-w-[280px] w-[85vw] sm:w-[350px] shrink-0 snap-center group relative overflow-hidden rounded-3xl bg-slate-50 shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 h-[450px]"
                    >
