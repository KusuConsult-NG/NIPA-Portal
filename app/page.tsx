...
export default function LandingPage() {
  return (
    <div className="bg-slate-50 text-slate-900 min-h-screen selection:bg-primary selection:text-white font-sans">
      <PublicHeader />
      <main>
        <HeroSlider />
        <div className="w-full bg-white border-y border-slate-200 py-10 shadow-sm relative z-10">
          <div className="max-w-[1280px] mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center md:border-r border-slate-100 last:border-0 pl-4 md:pl-0">
              <p className="text-primary text-4xl font-extrabold mb-1">2,500+</p>
              <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Global Members</p>
            </div>
            <div className="text-center md:border-r border-slate-100 last:border-0">
              <p className="text-navy-deep text-4xl font-extrabold mb-1">25</p>
              <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Active Years</p>
            </div>
            <div className="text-center md:border-r border-slate-100 last:border-0">
              <p className="text-navy-deep text-4xl font-extrabold mb-1">150+</p>
              <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Research Papers</p>
            </div>
            <div className="text-center pr-4 md:pr-0">
              <p className="text-secondary text-4xl font-extrabold mb-1">12</p>
              <p className="text-slate-500 text-xs font-bold uppercase tracking-widest">Key Committees</p>
            </div>
          </div>
        </div>
        <section className="max-w-[1280px] mx-auto px-6 lg:px-12 py-24 md:py-32">
          <div className="flex flex-col gap-20">
            <div className="flex flex-col gap-6 text-center items-center max-w-3xl mx-auto">
              <h2 className="text-navy-deep text-4xl md:text-5xl font-extrabold tracking-tight">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group relative bg-white border border-slate-200 p-10 rounded-3xl hover:shadow-xl hover:translate-y-[-5px] transition-all overflow-hidden shadow-sm">
                <div className="absolute -right-4 -top-4 size-32 bg-primary/5 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                ...
                <h3 className="text-navy-deep text-2xl font-bold mb-4">Promote NI Ideals</h3>
                <p className="text-slate-500 leading-relaxed font-medium">To promote the ideals of the National Institute in stimulating policy, leadership, and development engagements.</p>
              </div>
              <div className="group relative bg-white border border-slate-200 p-10 rounded-3xl hover:shadow-xl hover:translate-y-[-5px] transition-all overflow-hidden shadow-sm">
                <div className="absolute -right-4 -top-4 size-32 bg-secondary/5 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                ...
                <h3 className="text-navy-deep text-2xl font-bold mb-4">Professional Growth</h3>
                <p className="text-slate-500 leading-relaxed font-medium">To foster the professional and career growth of its members through continuous learning and networking.</p>
              </div>
              <div className="group relative bg-white border border-slate-200 p-10 rounded-3xl hover:shadow-xl hover:translate-y-[-5px] transition-all overflow-hidden shadow-sm">
                <div className="absolute -right-4 -top-4 size-32 bg-accent/5 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                ...
                <h3 className="text-navy-deep text-2xl font-bold mb-4">Public Policy</h3>
                <p className="text-slate-500 leading-relaxed font-medium">To contribute positively to public policy, governance, and the overall development of Nigeria.</p>
              </div>
            </div>
          </div>
        </section>
        <section className="max-w-[1280px] mx-auto px-6 lg:px-12 py-24 bg-white rounded-3xl mb-12 border border-slate-200 shadow-sm">
          <div className="flex flex-col gap-12">
            <div className="flex items-end justify-between">
              <div className="flex flex-col gap-3">
                <p className="text-primary font-bold text-xs uppercase tracking-[0.2em]">Live Sessions</p>
                <h2 className="text-navy-deep text-3xl md:text-4xl font-extrabold">Upcoming Summits</h2>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="group flex flex-col sm:flex-row gap-8 bg-slate-50 p-6 rounded-3xl border border-slate-200 hover:border-primary/30 transition-all hover:shadow-md">
                <div className="w-full sm:w-56 h-48 sm:h-auto rounded-2xl bg-slate-200 overflow-hidden shrink-0">
                ...
                <div className="flex flex-col justify-center py-2">
                  ...
                  <h4 className="text-navy-deep text-xl font-bold mb-3 group-hover:text-primary transition-colors">PSLC Policy Conversations</h4>
                  <p className="text-slate-500 text-[15px] leading-relaxed line-clamp-2">Engaging critical discussions on national issues to drive actionable policy outcomes.</p>
                </div>
              </div>
              <div className="group flex flex-col sm:flex-row gap-8 bg-slate-50 p-6 rounded-3xl border border-slate-200 hover:border-secondary/30 transition-all hover:shadow-md">
                <div className="w-full sm:w-56 h-48 sm:h-auto rounded-2xl bg-slate-200 overflow-hidden shrink-0">
                ...
                <div className="flex flex-col justify-center py-2">
                  ...
                  <h4 className="text-navy-deep text-xl font-bold mb-3 group-hover:text-secondary transition-colors">Annual Lecture Series</h4>
                  <p className="text-slate-500 text-[15px] leading-relaxed line-clamp-2">Platform for knowledge sharing and leadership development with industry experts.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="bg-slate-50 border-y border-slate-200 py-24">
          <div className="text-center max-w-3xl mx-auto mb-12 px-6">
            ...
            <h2 className="text-navy-deep text-3xl md:text-4xl font-extrabold">Meet the Executive Team</h2>
          </div>
          <LeadershipSlider />
        </section>

        <section className="max-w-[1280px] mx-auto px-6 lg:px-12 py-24 text-center">
          <div className="bg-navy-deep rounded-[2.5rem] p-12 md:p-24 border border-white/10 relative overflow-hidden">
