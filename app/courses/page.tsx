                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col leading-none">
                                <span className="text-xl font-black tracking-tight uppercase bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">NIPA</span>
                                    ...
                                    <div className="relative p-8 md:p-12 lg:p-16 max-w-3xl">
                                        ...
                                        <div className="flex flex-wrap gap-4">
                                            <button
                                                ...
                                                className="px-8 py-4 bg-gradient-to-r from-primary to-accent hover:brightness-110 text-white font-bold rounded-2xl shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:grayscale flex items-center gap-2"
                                            >
                                ...
                                {filteredCourses.map((course, idx) => (
                                    ...
                                    >
                                        ...
                                        <div className="h-48 overflow-hidden relative">
                                            ...
                                            />
                                            <div className="absolute inset-0 bg-gradient-to-t from-navy-card to-transparent opacity-80"></div>
                                        ...
                                        <div className="p-6">
                                            ...
                                            <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-slate-400 mb-3 line-clamp-2 min-h-[3.5rem]">
                                                {course.title}
                                            </h3>
